...
keys_set_1 = {0: "HELLO", 1: "BYE", 2: "YES", 3: "NO", 4: "GIVE",
              5: "TAKE", 6: "GM", 7: "GN", 8: "GOOD", 9: "BAD", 10: "GO", 11: "COME", 12: "THANKS", 13: "WELCOME", 14: "<"
              }
keys_set_2 = {0: "NURSE", 1: "WATER", 2: "LIGHT", 3: "FAN", 4: "ON",
              5: "OFF", 6: "TOILET", 7: "CLOTHES", 8: "HUNGRY", 9: "BATH",
              10: "SCRATCH", 11: "COLD", 12: "HOT", 13: "CLEAN", 14: "<"}
...
def draw_menu():
    ...
    cv2.line(keyboard, (int(cols / 2) - int(th_lines / 2), 0), (int(cols / 2) - int(th_lines / 2), rows),
             (51, 51, 51), th_lines)
    cv2.putText(keyboard, "COM", (80, 300), font, 6, (255, 255, 255), 5)
    cv2.putText(keyboard, "TASK", (80 + int(cols / 2), 300), font, 6, (255, 255, 255), 5)
...
while True:
    ...
    cv2.putText(board, text, (100, 100), font, 9, 0, 3)
